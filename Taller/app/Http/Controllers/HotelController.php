...
class HotelController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        //dd(name($request->get('name')));
        $this->hotelRepository->pushCriteria(new RequestCriteria($request));
        $hotels = $this->hotelRepository->orderBy('id','DESC')->all();
        //$myHotels = $hotels::name($request->get('name'));
       // $hotels = Hotel::name($request->get('name'))->orderBy('id','DESC')->paginate()
       //$comentarios = Comment::all();,compact('comentarios')
